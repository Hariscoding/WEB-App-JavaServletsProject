...
<html>
  ...
  <form action="Dodavanje" class="login-container" method="POST">
    ...
    <a href="index.jsp" id="registernowp2">
    <input value="Login" placeholder="Login" id="register_now2" type="button"></a>
